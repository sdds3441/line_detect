...
f, (ax1, ax2, ax3) = plt.subplots(1, 3, figsize=(100, 20))
#f.tight_layout()
ax1.imshow(l_channel)
ax1.set_title('HLS separate', fontsize=10)
ax2.imshow(s_channel)
ax2.set_title('Perspective transform', fontsize=10)
ax3.imshow(h_channel)
ax3.set_title('Sliding window', fontsize=10)
